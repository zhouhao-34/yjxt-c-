...
namespace warning
{
    public partial class FmLog : Form
    {
        ...
        public void readList(int PageIndex, int PageSize, int seach_menuID,string seach_type)
        {
            var list = list_BLL.proLogList(PageIndex, PageSize, seach_menuID, seach_type);
            ...
            //        this.LogView1.Rows[i].Cells[7].Value = list[i].manageType;
            //        this.LogView1.Rows[i].Cells[8].Value = sendUserName;
            //        this.LogView1.Rows[i].Cells[9].Value = sendType;
            //        this.LogView1.Rows[i].Cells[10].Value = list[i].createTime;
            //    }
            //}
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string seach_type = com_type.Text;
            readList(0, 6, seach_menuID, seach_type);
        }
    }
}
